...
import {Task, User, UserCredentials} from '../models';
...
export class UserController {
    ...
    @authenticate('jwt')
    async setPassword(
        @requestBody({description: 'update user'}) updatePasswordRequest: UpdatePasswordRequest,
    ): Promise<void> {
        // ensure a valid email value and password value


        validateCredentials(_.pick(updatePasswordRequest, ['email', 'password']));
        ...
        try {
            // set the password
            await this.userRepository
                .userCredentials(updatePasswordRequest.email)
                .patch({password});
